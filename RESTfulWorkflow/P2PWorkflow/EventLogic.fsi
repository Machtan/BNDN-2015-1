...
val get_event: EventName -> Repository -> ReadResult<Event * bool>

/// Check if given event have one of given roles
val check_roles: EventName -> Roles -> Repository -> ReadResult<bool>

/// Checks if given event is executeble
val check_if_executable: EventName -> UserName -> SendFunc<Repository> -> Repository -> ReadResult<ExecutableState>

/// Checks if given event is lock'et
val check_if_locked: EventName -> Repository -> ReadResult<bool>

/// Checks if given event is executed / excluded
val check_condition: EventName -> Repository -> ReadResult<bool>
